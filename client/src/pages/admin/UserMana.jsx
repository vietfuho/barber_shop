  ...
  export default function UserMana() {
    ...
    const [roleFilter, setRoleFilter] = useState(""); // ✅ thêm state lọc role
    ...
    return (
      <div className="p-6">
        <h2 className="text-2xl font-bold text-orange-500 mb-4">Quản lý người dùng</h2>

        {/* Thanh tìm kiếm + lọc role */}
        <div className="flex gap-3 items-center mb-4">
          ...
          <select
            ...
            className="border border-gray-300 p-2 rounded focus:ring-2 focus:ring-orange-400"
          >
