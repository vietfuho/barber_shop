  ...
  return (
    <div className="min-h-screen bg-gray-100 py-12 px-4 md:px-8">
      <div className="max-w-5xl mx-auto bg-white rounded-2xl shadow-2xl overflow-hidden flex flex-col md:flex-row">
        {/* Ảnh dịch vụ */}
        <div className="md:w-1/2 w-80% relative">
          <img
            src={
              service.imageUrl
                ? service.imageUrl
        ...
        {/* Nội dung dịch vụ */}
        <div className="md:w-1/2 w-80% p-6 flex flex-col justify-between">
          <div>
            ...
            <div className="gap-4 text-gray-700 text-sm">
          ...
          <div className="flex gap-4 mt-8">
            {/* ✅ Nút đặt lịch với check đăng nhập */}
            <button
              onClick={() => {
              ...
              className="flex-1 py-3 bg-orange-500 text-white rounded-xl font-semibold hover:bg-orange-600 transition duration-300"
            >
              Đặt lịch
            </button>
